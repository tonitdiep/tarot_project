...
Card.create(name: "Page of Wands", meaning_upright: "Inspiration, ideas, discovery, limitless potential, free spirit", meaning_reverse: "Newly-formed ideas, redirecting energy, self-limiting beliefs, a spiritual path", suit_id: wand.id)
